...
public class Transaction extends FinancialEntity {
    ...
    /**
     * Human-readable transaction number, distinct from {@code id} (the internal
     * uuid). Format: {@code {YYYY}-{billNumber}-{increment}}, e.g.
     * {@code 2026-CS-0001-1}. Generated by the {@code next_transaction_no()} DB
     * function (see V10) — never set manually.
     */
